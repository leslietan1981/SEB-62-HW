...
// npm init -y
// Add the following property as a new line in the package.json file:
...
// ^ Eric notes: exercise answers in exportingFile.js and importingFile.js. Run node importingFile.js in terminl to see the results.
...
//
// Your code here:
function englishGrammer(noun = "cat", adjective = "orange") {
  console.log(`The ${noun} is ${adjective}.`);
}

englishGrammer("bunny", "brown");
...
// Your code here:
let foodReview = pizza === "tasty" ? "yum" : "yuck";
...
const localLangConfig = "cn"; // Change to 'es', 'fr', etc., or leave it `null`.
