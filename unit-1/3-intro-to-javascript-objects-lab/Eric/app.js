...
for (const myPokemon of game.party) {
...
*/
for (const starterPokemonName of pokemon) {
  if (starterPokemonName.starter === true) {
    console.log(starterPokemonName.name);
  }
}
...
*/
for (const lateGame of game.gyms) {
  if (lateGame.difficulty < 8) {
